# Módulo AWS Load Balancer Controller
# Configura IAM roles y políticas necesarias para que el controller pueda crear ALBs
...
resource "aws_iam_policy" "alb_controller" {
  ...
  description = "Política para AWS Load Balancer Controller"
    ...
    Statement = [
      ...
      },
      {
        ...
        Action = [
          ...
          "elasticloadbalancing:ModifyListener", "elasticloadbalancing:SetWebAcl", "elasticloadbalancing:ModifyRule"
        ]
        Resource = "*"
      },
      {
...
# IAM Role para el Service Account del controller
